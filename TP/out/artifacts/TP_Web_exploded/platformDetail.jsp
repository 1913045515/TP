...
<script type="text/javascript">
	function updateInfo(){
		...
		var invalidTime=document.getElementById("invalidTime").value;
		  $.post("http://127.0.0.1:8888/TP/platformAction?type=update", {  
                id:id,
                price:price,
...
<body>
    ...
    <div class="maincontainer">
    	<div class="columnconn">
            ...
            <a href="platformList.jsp"><input type="button" name="submit" class="btn" value="返回上一个界面" style="margin-left: 900px;"/></a>
        </div>
        <div class="fmcontainer">
            <table class="inputtable" width="100%">
                <tr>
                    <td class="leftlabel">平台 ID：</td><td><input id="id" type="text" value="${list[0].id}" disabled="true"/></td>
                    <td class="leftlabel">付款人ID：</td><td><input id="sUId" type="text" value="${list[0].sUId}" disabled="true"/></td>    
                    <td class="leftlabel">收款人ID：</td><td><input id="gUId" type="text" value="${list[0].gUId}" disabled="true"/></td>                        
                </tr>
                <tr>
                	<td class="leftlabel">订单ID：</td><td><input id="oId" type="text" value="${list[0].oId}" disabled="true"/></td>         
                	<td class="leftlabel">订单金额：</td><td><input id="price" type="text" value="${list[0].price}"/></td>         
                    <td class="leftlabel">付款时间：</td><td><input id="completeTime" type="text" value="${list[0].completeTime}" disabled="true"/></td>    
                </tr>  
                 <tr>
                   <td class="leftlabel">失效时间：</td><td><input id="invalidTime" type="text" value="${list[0].invalidTime}"/></td>         
