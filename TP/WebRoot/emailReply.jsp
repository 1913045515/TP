...
<div style="margin-left:20px;margin-top:5px;">
	<div>
        <h5>联系人:<input type="text" id="usersId" name="usersId" value="${resultValue.from}" style="margin-left: 10px;margin-top: 2px;width: 800px;height: 25px"/></br>
        <h5>主题:<input type="text" id="themes" name="themes"  value="${resultValue.subject}" style="margin-left: 25px;margin-top:2px;width: 800px;height: 25px"/>
    </div>
	<div  style="float:left;">
		 内容：<script id="editor" name="content" type="text/plain" style="width:800px;height:300px;margin-left:50px;">
				<div>
					<br><br><br><br><br><br><br><br><br><br>
					<p style="border:5px;background-color:#C1C1C1;">原邮件内容：${resultValue.content}</p>
					<p style="border:5px;background-color:#C1C1C1;">时间：${resultValue.senddate}</p>
				</div>
			</script>
	</div>
