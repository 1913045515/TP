...
<script type="text/javascript">
	function updateInfo(){
		...
		var path=document.getElementById("path").value;
		  $.post("/TP/classificationAction?type=update", {  
                id:id,
                name:name,
                describle:describle,
                path:path
    ...
    <div class="maincontainer">
        ...
        <div class="fmcontainer">
            <table class="inputtable" width="100%">
                <tr>
                    <td class="leftlabel">类型 ID：</td><td><input id="id" type="text" value="${list[0].id}" disabled="true"/></td>
                    <td class="leftlabel">类型名称：</td><td><input id="name" type="text" value="${list[0].name}"/></td>                        
                </tr>
                <tr>
                	<td class="leftlabel">类型描述：</td><td><input id="describle" type="text" value="${list[0].describle}"/></td>         
                    <td class="leftlabel">类型路径：</td><td><input id="path" type="text" value="${list[0].path}"/></td>                        
                </tr>  
                 <tr>
