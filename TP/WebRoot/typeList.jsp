...
$(function(){
	$("#datagrid").datagrid({
		...
		toolbar:"#toolbar",
		columns:[[  
			{field:'id',title:'类型ID',width:100,align:'center'},  
			{field:'name',title:'类型名称',width:150,align:'center'},  
			{field:'describle',title:'类型描述',width:400,align:'center'},  
			{field:'path',title:'图片路径',width:150,align:'center'},  
			{field:'btId',title:'点击修改',width:100,align:'center',
				 formatter:function(value,rec){  
                	var btn = '<a href="classificationAction?type=detail&showId='+value+'">修改信息</a>';  
                	return btn;  
           		 }  
			}
		]],  
		url:'/TP/classificationAction?type=all&pageNumber=1&pageSize=20'
	});  
	 ...
	 function SearchTrainee(pageNumber, pageSize) {  
           ...
           $.post("/TP/classificationAction?type=all", {  
   ...
   function search(value,name){
   	  $.post("/TP/classificationAction?type=selete", 
            ...
            <div id="toolbar">  
                ...
                <div class="searchcon">
					...
					<div id="mm" style="width:120px"">
   						 <div data-options="name:'id',iconCls:'icon-ok'">类型ID</div>
    					 <div data-options="name:'name',iconCls:'icon-ok'">类型名称</div>
					</div>
                </div>
		 	</div>
